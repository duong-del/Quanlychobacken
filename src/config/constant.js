...
config();
//MONGODB
export const MONGODB_URI = `mongodb+srv://duongnq26012003:<password>@cluster0.yjgbwmo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
export const MONGODB_PASS = "7Ow38iwr7WzCkbiz"
...
//KEY
export const SECRET_KEY_ADMIN = process.env.SECRET_KEY_ADMIN || "keya";
export const SECRET_KEY_USER = process.env.SECRET_KEY_USER || "keyu";
...
export const JOI_DEFAULT_MESSAGE = {
    ...
    "any.invalidmore" : "{{#label}} một hoặc nhiều không hợp lệ",
